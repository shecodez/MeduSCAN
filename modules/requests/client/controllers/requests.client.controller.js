(function () {
    ...
    function RequestsController($scope, $state, Authentication, request, DataFactory, toastService) {
        ...
        function init() {
            vm.subs = []; angular.forEach(vm.request.subscribers, function(value){vm.subs.push(value); });
            ...
            angular.forEach(vm.subs, function(sub){
                ...
                DataFactory.getData(data, id).then(
                    function(userData) {
                        ...
                        subData.firstName = userData.firstName; subData.lastName = userData.lastName;
